...
namespace TaTeTi_1._0
{
    ...
    {   
        ...
        private bool isDraw;
        // Evento para notificar cuando el juego termina
        ...
        public bool newMove(byte row, byte col) //realiza
        {   
            if (DrawCont == 8)
            {
                isDraw = true;
        ...
        private void gameReset() //resetea el mapa o tablero
        {
            game = new bool?[3, 3];
        }

        public void gameFullReset() //restea todo el juego
        {
            game = new bool?[3, 3];
            player = true;
            playerInit = true;
        ...
        private void winer(bool player)
        {
           ...
           // MessageBox.Show("Gano el jugador " +player.ToString());
